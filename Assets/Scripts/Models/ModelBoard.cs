...
namespace Reversi.Models
{
    ...
    public class ModelBoard
    {
        ...
        public DiscInfo[,] DiscInfos = new DiscInfo[GlobalConfigs.Lines, GlobalConfigs.Lines];
        ...
        List<Vector2Int> directions = new List<Vector2Int>()
    {
        ...
        public void SetGameStartDiscs()
        {
            ...
            foreach (KeyValuePair<Vector2Int, DiscSide> InitInfoItem in GlobalConfigs.InitInfo)
            {
        ...
        {
            return (pos.x >= 0 && pos.y >= 0 && pos.x < GlobalConfigs.Lines && pos.y < GlobalConfigs.Lines);
        }
        ...
        void GetScores(out int black_score, out int white_score)
        {
            black_score = 0;
            white_score = 0;
            for (int x = 0; x < GlobalConfigs.Lines; x++)
            {
                for (int y = 0; y < GlobalConfigs.Lines; y++)
                {
